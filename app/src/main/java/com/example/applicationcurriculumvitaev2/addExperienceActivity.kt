...
class addExperienceActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        actionbar!!.title = "Add Experience"
        ...
        binding.next.setOnClickListener {
            ...
            dataBase.expDAO().insert(Experience(0, encodedImage, binding.companyNameInput.text.toString(), binding.companyAddressInput.text.toString(), binding.startdateInput.text.toString(), binding.enddate.text.toString()));
            setResult(1337)
